    ...
    internal class Program
    {
        ...
        static void ShowMainMenu()
        {
            while (true)
            {
                ...
                Console.WriteLine("  [3] Export Swing Tech Data");
                Console.WriteLine("  [4] Export Difficulty Breakdown");
        ...
        static void RunExportSwingTech()
        {
            Console.Clear();
            Console.WriteLine("╔════════════════════════════════════════════════╗");
            Console.WriteLine("║   Export Swing Tech Data                       ║");
            Console.WriteLine("╚════════════════════════════════════════════════╝");
            Console.WriteLine();
            Console.WriteLine("This export shows all variables used in SwingTech calculation:");
            Console.WriteLine("  • Angle Strain");
            Console.WriteLine("  • Path Strain");
            Console.WriteLine("  • NJS Buff");
            Console.WriteLine("  • Swing Tech (Total)");
            Console.WriteLine();
            ...
            Console.Write("Enter output path (or press Enter for 'swing_tech.html'): ");
            string outputPath = Console.ReadLine()?.Trim();

            Console.WriteLine();
            Console.WriteLine("Starting swing tech analysis...");
            Console.WriteLine();

            try
            {
                var exporter = new AnalysisExporter();
                exporter.ExportSwingTechDataFromFile(input, characteristic, difficulty, string.IsNullOrEmpty(outputPath) ? null : outputPath);
            }
            catch (Exception ex)
            {
                Console.WriteLine($"Error: {ex.Message}");
