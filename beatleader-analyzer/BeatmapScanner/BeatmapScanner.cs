...
namespace Analyzer.BeatmapScanner
{
    internal class BeatmapScanner
    {
        ...
        public static Ratings AnalyzerWithCurveDebug(List<Note> notes, List<Chain> chains, List<Bomb> bombs, List<Wall> walls, float bpm, float timescale, float njsMult = 1, bool strictAngles = false)
        {
            Ratings ratings;
            List<Cube> cubes = [];
            ...
            return Analyze.UseLackWizAlgorithmWithCurveDebug(red, blue, bpm, walls, bombs, strictAngles);
        }
    }
}
